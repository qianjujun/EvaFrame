...
public class GroupViewModuleItemDecoration extends RecyclerView.ItemDecoration{
    ...
    private GroupViewModule3 viewModule;
    ...
    public GroupViewModuleItemDecoration(GroupViewModule3 viewModule, int dividerHeight){
    ...
    public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if(viewModule.getDataType(dataPosition)==GroupViewModule3.DATA_TYPE_CHILD){
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            int dataPosition = adapterPosition-viewModule.getStartPosition();
            if(isValidItem(adapterPosition)&&viewModule.getDataType(dataPosition)==GroupViewModule3.DATA_TYPE_CHILD){//只绘制子项
