...
import com.qianjujun.frame.adapter.group.GroupInfoData;
import com.qianjujun.frame.adapter.group.OnChildItemClickListener;
import com.qianjujun.frame.adapter.group.OnGroupItemClickListener;
import com.qianjujun.frame.adapter.group.OnGroupModule3ItemListener;
 ...
 * @describe
 */
public abstract class GroupViewModule3<C, G extends GroupData<C>> extends ViewModule<G> {
    ...
    protected abstract ChildHolder<?> onCreateChildViewHolder(ViewGroup parent, int viewType);

    protected abstract GroupHolder<?> onCreateGroupTopViewHolder(ViewGroup parent, int viewType);

    protected GroupHolder<?> onCreateGroupBottomViewHolder(ViewGroup parent, int viewType) {
        return new GroupHolder<SpcaeViewmodelBinding>(R.layout.spcae_viewmodel, parent) {
            @Override
            protected void onBindData(SpcaeViewmodelBinding dataBing, G group, int groupIndex, int dataPosition,boolean expend) {
                // do nothing
    ...
    public abstract class ChildHolder<DB extends ViewDataBinding> extends BaseViewHolder<G, DB> {
    ...
    public abstract class GroupHolder<DB extends ViewDataBinding> extends BaseViewHolder<G, DB> {
    ...
    protected @IntRange(from = 0, to = 300)
